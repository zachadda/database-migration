--/
create or replace script EXA_DB_MIGRATION.AZURE_SQL_TO_EXASOL(
    CONNECTION_NAME
    , SCHEMA_FILTER
    , TABLE_FILTER
...
-- This script maintains backward compatibility with the legacy AZURE_SQL_TO_EXASOL signature
...
table.insert(legacy_result, {
    NULL,
    'FALSE',
    'WARNING: AZURE_SQL_TO_EXASOL is deprecated; use MIGRATE_TO_EXASOL(\'azure_sql\', ...).'
})
