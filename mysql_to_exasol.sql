--/
create or replace script EXA_DB_MIGRATION.MYSQL_TO_EXASOL(
    CONNECTION_NAME
...
-- This script maintains backward compatibility with the legacy MYSQL_TO_EXASOL signature
...
table.insert(legacy_result, {
    NULL,
    'FALSE',
    'WARNING: MYSQL_TO_EXASOL is deprecated; use MIGRATE_TO_EXASOL(\'mysql\', ...).'
})
