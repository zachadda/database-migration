--/
create or replace script EXA_DB_MIGRATION.MARIADB_TO_EXASOL(
    CONNECTION_NAME
...
-- This script maintains backward compatibility with the legacy MARIADB_TO_EXASOL signature
...
table.insert(legacy_result, {
    NULL,
    'FALSE',
    'WARNING: MARIADB_TO_EXASOL is deprecated; use MIGRATE_TO_EXASOL(\'mariadb\', ...).'
})
