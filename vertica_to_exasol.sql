--/
create or replace script EXA_DB_MIGRATION.VERTICA_TO_EXASOL(
    CONNECTION_NAME
...
-- This script maintains backward compatibility with the legacy VERTICA_TO_EXASOL signature
...
table.insert(legacy_result, {
    NULL,
    'FALSE',
    'WARNING: VERTICA_TO_EXASOL is deprecated; use MIGRATE_TO_EXASOL(\'vertica\', ...).'
})
