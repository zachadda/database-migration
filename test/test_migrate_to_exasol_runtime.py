...
ADAPTERS = {
    ...
    "DUCKDB": ("DUCKDB_TO_EXASOL", "CONNECTION_NAME, IDENTIFIER_CASE_INSENSITIVE, SCHEMA_FILTER, TABLE_FILTER"),
    "STARROCKS": ("STARROCKS_TO_EXASOL", "CONNECTION_NAME, IDENTIFIER_CASE_INSENSITIVE, SCHEMA_FILTER, TABLE_FILTER"),
    "CLICKHOUSE": ("CLICKHOUSE_TO_EXASOL", "CONNECTION_NAME, IDENTIFIER_CASE_INSENSITIVE, SCHEMA_FILTER, TABLE_FILTER"),
    "DREMIO": ("DREMIO_TO_EXASOL", "CONNECTION_NAME, IDENTIFIER_CASE_INSENSITIVE, DB_FILTER, SCHEMA_FILTER, TABLE_FILTER"),
    "TRINO": ("TRINO_TO_EXASOL", "CONNECTION_NAME, IDENTIFIER_CASE_INSENSITIVE, DB_FILTER, SCHEMA_FILTER, TABLE_FILTER"),
}
